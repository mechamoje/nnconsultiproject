...
import { MdOutlineHealthAndSafety, MdOutlineDateRange, MdOutlineSolarPower } from "react-icons/md"
...
export default function Services() {
    ...
    return (
        <Section id='services'>
            <SectionTitle title="Nossos serviços" subtitle="O que oferecemos aos nossos clientes" />
            <ServicesList>
                {servicesList.map((service) => (
                    ServicesIcon(service.icon, service.title, () => console.log(service.title))
                ))}
            </ServicesList>
        </Section>
    );
