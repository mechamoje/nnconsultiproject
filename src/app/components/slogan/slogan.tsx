    ...
    return (
        <Section id='home'>
            <MobileHeader>
                <ul>
                    <li>
                        ...
                        /> </li>
                    <li><a href="https://api.whatsapp.com/send?phone=5581991620892&text=Gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre:%20"><RiWhatsappFill color={'black'} size={60} /></a> </li>
                </ul>
            ...
            <Header isOpenProp={isOpen}>
                ...
                <ul id="logo">
                    <li><a target="blank" href={links.whatsappLink}>
                        <RiWhatsappFill color={'#5aa81d'} size={45} />
                    </a>
                    </li>
                    <li><a href={links.linkedinLink} target="blank">
            ...
            <Article>
                <h2>NN Consulti</h2>
                <p>
                    Uma empresa criada para facilitar a vida daqueles que vivem e respiram Tech dia após dia.
                </p>
                <Button isUppercase={true} text="Entre em contato" url={links.whatsappLink}> </Button>
            </Article>
        </Section>
    )
}
